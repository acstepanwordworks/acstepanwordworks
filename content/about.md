...
I also believe in using AI for good. As a volunteer with the <a href="https://txczechproject.laits.utexas.edu/" target="_blank" rel="noopener noreferrer">Texas Czech Legacy Project</a>, I'm part of a team using AI-assisted transcription to preserve an endangered dialect of Czech spoken only in rural Texas — scaling what would otherwise be impossible work. That's what responsible AI use looks like in practice.